...
partial class MainForm
{
    ...
    private Panel BuildResultsPanel()
    {
        ...
        startButton = MakeButton("开始检查", Color.White, Color.FromArgb(56, 82, 105), 105); startButton.Click += StartButton_Click;
        ...
        selectedFolderGrid.Columns.Add("Folder", "文件夹"); selectedFolderGrid.Columns.Add("Path", "绝对路径"); selectedFolderGrid.Columns.Add(new DataGridViewButtonColumn { Name = "Remove", HeaderText = "操作", Text = "移除", UseColumnTextForButtonValue = true });
        SetColumn(selectedFolderGrid.Columns[0], 180, 120); SetColumn(selectedFolderGrid.Columns[1], 430, 200); SetColumn(selectedFolderGrid.Columns[2], 75, 65);
        ...
        right.RowStyles.Add(new RowStyle(SizeType.Absolute, 117)); right.RowStyles.Add(new RowStyle(SizeType.Absolute, 34)); right.RowStyles.Add(new RowStyle(SizeType.Percent, 100));
        ...
        right.Controls.Add(detailTitleLabel, 0, 1);
        var issueHost = new Panel { Dock = DockStyle.Fill };
        issueGrid = new DataGridView { Dock = DockStyle.Fill, ReadOnly = true, AllowUserToAddRows = false, AllowUserToDeleteRows = false, AllowUserToResizeColumns = true, RowHeadersVisible = false, MultiSelect = false, SelectionMode = DataGridViewSelectionMode.FullRowSelect, AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.None, ScrollBars = ScrollBars.Both, BackgroundColor = Color.White, BorderStyle = BorderStyle.None };
        ...
        issueGrid.Columns.Add("Status", "状态"); issueGrid.Columns.Add("Category", "具体类别"); issueGrid.Columns.Add("Device", "设备目录"); issueGrid.Columns.Add("File", "TXT 文件"); issueGrid.Columns.Add("Message", "说明"); issueGrid.Columns.Add("Actual", "实际内容"); issueGrid.Columns.Add("Path", "完整路径"); issueGrid.Columns.Add(new DataGridViewButtonColumn { Name = "Operation", HeaderText = "操作", Text = "打开位置  ▼", UseColumnTextForButtonValue = true });
        SetColumn(issueGrid.Columns[0], 75, 65); SetColumn(issueGrid.Columns[1], 190, 130); SetColumn(issueGrid.Columns[2], 230, 140); SetColumn(issueGrid.Columns[3], 250, 140); SetColumn(issueGrid.Columns[4], 390, 220); SetColumn(issueGrid.Columns[5], 320, 180); SetColumn(issueGrid.Columns[6], 450, 230); SetColumn(issueGrid.Columns[7], 125, 110);
        ...
        issueHost.Controls.Add(emptyMessageLabel); issueHost.Controls.Add(issueGrid); right.Controls.Add(issueHost, 0, 2); split.Panel2.Controls.Add(right);
