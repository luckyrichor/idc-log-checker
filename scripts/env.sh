...
export DOTNET_BUNDLE_EXTRACT_BASE_DIR="$PROJECT_ROOT/.tools/bundle-extract"
export DOTNET_NOLOGO=1
export DOTNET_CLI_TELEMETRY_OPTOUT=1
export DOTNET_SKIP_FIRST_TIME_EXPERIENCE=1
export PATH="$DOTNET_ROOT:$PATH"

mkdir -p "$DOTNET_CLI_HOME" "$NUGET_PACKAGES" "$NUGET_HTTP_CACHE_PATH" "$TMPDIR" "$DOTNET_BUNDLE_EXTRACT_BASE_DIR"
